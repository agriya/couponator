	...
	<div class="main-left-shadow">
		<div class="main-right-shadow">
			...
			<div class="admin-side1-tc admin-side1-tc1 clearfix">
				...
				<div class="admin-center-block clearfix dashboard-center-block <?php echo (empty($this->request->params['isAjax']))? '' : ''; ?>" id="admin-dashboard-user-login<?php echo $user_type_id; ?>">
					<div class="clearfix">
