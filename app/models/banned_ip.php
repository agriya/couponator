...
class BannedIp extends AppModel
{
    ...
    // public function to check the given ip is in banned lists or not
    public function checkIsIpBanned($ip = null)
    {
        $ip = ip2long($ip);
    ...
    public function _checkDomainUrl()
    {
    ...
    public function checkRefererBlocked($url = null)
    {
        if (!empty($url)) {
    ...
    public function isRangeRequired()
    {
    ...
    public function isDurationRequired()
    {
