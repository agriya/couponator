...
$facebook_settings_id = 39;
$twitter_settings_id = 40;
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>Couponator - Diagnostic Tool</title>
<style type="text/css">
body{
	color:#4c4c4c;
	line-height:18px;
...
function _db_check($database = 'default',$facebook_settings_id,$twitter_settings_id)
{
    ...
    if ($link) {
        ...
        if ($db_selected) {
            ...
            $result = mysql_query("select * from settings where setting_category_parent_id in (1, 2, 8)", $link);
...
<h1>Couponator Diagnostic Tool</h1>
...
<p class="info-details">
    ...
    <span>
		...
		<br/>For more info: <a href="http://dev1products.dev.agriya.com/doku.php?id=couponator-install#setting_up_files" target="_blank">http://dev1products.dev.agriya.com/doku.php?id=couponator-install#setting_up_files</a>
	</span>
</p>
...
<p class="info-details">
    ...
    <span>
		...
		<br/>For more info: <a href="http://dev1products.dev.agriya.com/doku.php?id=couponator-install#setting_up_database" target="_blank">http://dev1products.dev.agriya.com/doku.php?id=couponator-install#setting_up_database</a>
	</span>
</p>
...
<p class="info-details">
    ...
    <span>
		...
		<br/>For more info: <a href="http://dev1products.dev.agriya.com/doku.php?id=couponator-install#manage_settings" target="_blank">http://dev1products.dev.agriya.com/doku.php?id=couponator-install#manage_settings</a>
	</span>
</p>
<?php
...
?>
                            ...
                            $settings_check_one_zero = array(
								...
								'facebook.enable_facebook_post_coupon',
								'twitter.enable_twitter_post_of_coupon'
                            );
